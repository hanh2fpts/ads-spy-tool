...
- Cache kết quả 1 giờ, có nút Clear Cache để lấy dữ liệu mới
...
| **Clear Cache** | Xóa cache để lấy dữ liệu mới nhất |
...
- Cache tự xóa sau 1 giờ. Dùng nút **Clear Cache** nếu muốn lấy dữ liệu mới ngay
